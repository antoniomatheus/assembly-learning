...
#options for open (look atk /usr/include/asm/fcntl.h for various
#values. You can combine them by adding them or ORing the)
...
#mode for new file (i.e. permission bits if the file is created)
movl $0666, %edx
#call linux
int $LINUX_SYSCALL
